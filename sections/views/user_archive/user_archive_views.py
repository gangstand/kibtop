...
class UserArchiveLimitPagination(MultipleModelLimitOffsetPagination):
    default_limit = 10


class UserArchiveAPIList(generics.ListAPIView):
    serializer_class = CategoryFullSerializer
    permission_classes = (IsAuthenticatedOrReadOnly,)
    filterset_class = FilterCategory
    pagination_class = UserArchiveLimitPagination
