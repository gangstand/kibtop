    ...
    return (
        <>
            <div className="container container--width container--margin">
                <h1 className="title title--profile"><Text content="Add advert" /></h1>
            ...
            <div className="category-wrapper">
                ...
                <div className="category-line">
                    <DeskCategoryInput {...{value: 'Apartment', categoryName: 'Real estate'}} />
                    <DeskCategoryInput {...{value: 'House', categoryName: 'Real estate'}} />
                    <DeskCategoryInput {...{value: 'land', categoryName: 'Real estate'}} />
                    <DeskCategoryInput {...{value: 'Other', categoryName: 'Real estate'}} />
