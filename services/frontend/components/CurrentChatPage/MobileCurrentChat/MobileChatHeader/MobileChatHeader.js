...
import LogoComponent from "../../../ChatPage/ActiveDialog/ActiveDialogComponents/_HeaderComponents/LogoComponent";
import UsernameComponent from "../../../ChatPage/ActiveDialog/ActiveDialogComponents/_HeaderComponents/UsernameComponent";
import style from "../mobile_chat.module.scss"


const MobileChatHeader = ({talk, connectedUsers}) => {
    const seller = talk || {}
