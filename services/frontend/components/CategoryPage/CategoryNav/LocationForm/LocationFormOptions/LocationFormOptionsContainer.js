                ...
                isOpen && <>
                    <div className="modal-screen modal-screen--location modal-screen--filter" {...swipe}>
                        <div className="location-select" >
                            ...
                            <LocationFormOptions {...{options, onChange: changeValue, href, onSwitchOpen: onSwitchOpenReset}} />

                            <Link href={href()} onClick={onSwitchOpenReset} className="btn btn--hug">
                                <Text content="Apply" />
                            </Link>

                            <button className="close-location" onClick={onSwitchOpenReset}>
...
export default LocationFormOptionsContainer;