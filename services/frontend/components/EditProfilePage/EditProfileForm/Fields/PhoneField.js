...
import style from "../../../AddAdvertPage/AddPhone/AddPhoneForm/AddPhoneField/add_tel.module.scss"
import Codes from "../../../AddAdvertPage/AddPhone/AddPhoneForm/AddPhoneField/Codes"
import { useBoolState } from "../../../AppHooks/useBoolState"

const PhoneField = ({defaultValue}) => {
    ...
    return (
        <>
            <div className={`form__field ${style.emptyField}`} style={{overflow: 'initial'}}>
                    ...
                    <div className={style.emptyCodeWrapper}>
