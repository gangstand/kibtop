...
const DetailCard = ({cost, isMonth, phone, currency, auth, userId, isLoading, createDialog}) => {
        ...
        <>
            <div className="detail-card">
                <div className="detail-card__wrapper">
                    ...
                    <button onClick={createDialog.mutate} className="contact-btn contact-btn--blue" disabled={!auth.isAuthed || isLoading || auth.userId === userId } >
                        <svg viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
