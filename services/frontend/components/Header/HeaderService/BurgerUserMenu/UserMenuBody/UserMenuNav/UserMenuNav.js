...
const UserMenuNav = ({isAuthed}) => {
    ...
    return (
        <nav>
            ...
            <Link href={isAuthed ? "/messages" : "/registration"} className={isAuthedStyle}>
                <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link href={isAuthed ? "/add_advert" : "/registration"} className={'user-menu__text user-menu__item'}>
                <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
