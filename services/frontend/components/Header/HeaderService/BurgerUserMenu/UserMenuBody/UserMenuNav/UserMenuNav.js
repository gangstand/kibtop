...
const UserMenuNav = ({isAuthed, onClose}) => {
    ...
    return (
        <nav>
            <Link href={isAuthed ? "/favorites" : "/registration"} onClick={onClose} className={isAuthedStyle}>
            ...
            <Link href={isAuthed ? "/messages" : "/registration"} onClick={onClose} className={isAuthedStyle}>
                <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link href={isAuthed ? "/add_advert" : "/registration"} onClick={onClose} className={'user-menu__text user-menu__item'}>
                <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
