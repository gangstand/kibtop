...
import {select, selectOptions, selectArrow, selectTitle, adaptiveSelect} from "../../../filter.module.scss"
...
const LocationSelect = () => {
    ...
    return (
        <>
            <div className={adaptiveSelect} style={{marginBottom: 12}}>
                <button onClick={onSwitchOpen}>
                    {!!cityValue ? cityValue : <Text content={'Location'} />}
                </button>
            ...
            <LocationInputContainer {...{onSwitchOpen, isOpen}} />
