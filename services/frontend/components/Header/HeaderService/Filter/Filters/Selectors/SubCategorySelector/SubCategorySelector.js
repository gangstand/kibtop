...
import {select, backDropper, selectArrow, selectScroll, selectScrollOptions, categoryTitle} from "../../../filter.module.scss"
...
const SubCategorySelector = ({holder, name, items, disabled, zIndex}) => {
    ...
    return (
        <>
            <div className={select} style={isOpen ? {...selctedStyle, marginTop: 12} : {marginTop: 12}} >
