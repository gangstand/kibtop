...
WORK_CATEGORY_RU = [
    ...
    ('Красота | Фитнес | Спорт', 'Красота | Фитнес | Спорт'),
    ...
    ('Реклама | Дизайн | Пиар', 'Реклама | Дизайн | Пиар'),
    ('Производство | Рабочие специальности', 'Производство | Рабочие специальности'),
    ('Работа за границей', 'Работа за границей'), ('Бухгалтерский учет', 'Бухгалтерский учет'),
...
WORK_CATEGORY_TR = [
    ...
    ('Güzellik | Fitness | Spor Dalları', 'Güzellik | Fitness | Spor Dalları'),
    ('Eğitim | tercüme', 'Eğitim | tercüme'),
    ('Kültür | Sanat | Eğlence', 'Kültür | Sanat | Eğlence'),
    ('Tıp | Eczane', 'Tıp | Eczane'),
    ('IT | bilgisayar', 'IT | bilgisayar'),
    ('Bankacılık | Finans | Sigorta | İçtihat', 'Bankacılık | Finans | Sigorta | İçtihat'),
    ('Emlak', 'Emlak'),
    ('Reklam | Tasarım | PR', 'Reklam | Tasarım | PR'),
    ('Üretim | Çalışma Uzmanlıkları', 'Üretim | Çalışma Uzmanlıkları'),
    ('Yurt dışında çalışmak', 'Yurt dışında çalışmak'),
    ('Muhasebe', 'Muhasebe'),
    ...
    ('Diğer Meslekler', 'Diğer Meslekler')
]
FOR_WORK_EN = [
    ('For work', 'For work'),
